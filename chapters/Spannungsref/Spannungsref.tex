...
Die Bandgap-Schaltung hat den Nachteil, dass Vref relativ stark vom Offset-Spannungsfehler $V_{off}$ des Opamp abhängt. Man kann zeigen dass $V_{ref}=V_{EV1}+\frac{R_2}{R_3}\cdot\Phi_t\cdot\left[\frac{R_2A_2}{R_1A_1}\cdot\left( 1-\frac{V_{eff}}{R_2I_2}\right)\right]-\left(1+\frac{R_2}{R_3}\right)\cdot V_{off}$