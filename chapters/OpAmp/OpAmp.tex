...
\begin{tabular}{p{0.3\textwidth}p{0.6\textwidth}}
	...
	Common mode rejection ratio&$a_{DM}=\left.\frac{v_O}{V_{DM}}\right|_{v_{CM}=0}$ (ideal $a_{DM}=\infty$) differential mode, Gegentaktverstärkung\\
	&$a_{CM}=\left.\frac{v_O}{V_{CM}}\right|_{v_{DM}=0}$ (ideal $a_{CM}=0$) common mode, Gleichtaktverstärkung\\
