...
\begin{tabular}{|p{0.3025\textwidth}|p{0.3025\textwidth}|p{0.3025\textwidth}|}
	...
	\includegraphics[height=5cm]{chapters/Stromquelle/images/einfacheStromquelle}&\includegraphics[height=5cm]{chapters/Stromquelle/images/Kaskode}&\includegraphics[height=5cm]{chapters/Stromquelle/images/geregelteKaskode}\\ \hline
\end{tabular}\\ 
\begingroup\setlength{\LTleft}{-20cm plus -1fill}\setlength{\LTright}{\LTleft}\begin{longtable}{|l|l|l|}
	\hline
